							...
							<div class="single_page">
								<div class="bootstrap-tab-text-grids">
									...
									<div class="add-review">
										...
										<form action="#" method="post">
											<input type="hidden" value="<?php echo $id ?>" name="product_binhluan_id">
											<input placeholder="Điền Tên" type="text" name="Name" required="Name">
											<textarea placeholder="Bình Luận" name="Message" required=""></textarea>
